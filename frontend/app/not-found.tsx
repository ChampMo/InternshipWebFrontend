...
export default function NotFound() {
  ...
  if(permissions === null){
    return (
      <div className='fixed inset-0 w-screen h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50' style={{ zIndex: 9999 }}>
        <PulseLoader
          loading={true}
          size={16}
